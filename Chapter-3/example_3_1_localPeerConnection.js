...
// JavaScript variable associated with HTML5 video element in this page
var localVideo = document.getElementById('localVideo');
var remoteVideo = document.getElementById('remoteVideo');

//JavaScript variable assciated with call management buttons in this page
...
// It will call when you give access to local media 
...
function start() {
    ...
    // first of all disable start button
    ...
    // function simply attaches the local stream (containing both audio and video tracks)
    // ...to the localVideo element in the HTML5 page
    // Associate the local video element with the retrieved stream
...
function call() {
    ...
    if (navigator.webkitGetUserMedia) {
        // Log into about video and audio device in use
    ...
    localPeerConnection.onicecandidate = gotLocalIceCandidate; //it is a function define please find it

    //Create the remote PeerConnection object
    remotePeerConnection = new RTCPeerConnection(servers);
    log('Created remote peer connection object remotePeerConnection');
    
    //Add a handler associated with ICE (Interactive Connectivity Establishment) protocol events
    //----
    // The RTCPeerConnection.onicecandidate property is an EventHandler which specifies a function 
    // ...to be called when the icecandidate event occurs on an RTCPeerConnection instance. 
    // This happens whenever the local ICE agent needs to deliver a
